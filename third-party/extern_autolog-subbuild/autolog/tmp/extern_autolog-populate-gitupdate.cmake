...
execute_process(
  COMMAND "E:/Git/cmd/git.exe" --git-dir=.git show-ref "main"
  WORKING_DIRECTORY "E:/PaddleOCR/deploy/cpp_infer/build/third-party/extern_autolog-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'E:/PaddleOCR/deploy/cpp_infer/build/third-party/extern_autolog-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'E:/PaddleOCR/deploy/cpp_infer/build/third-party/extern_autolog-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
